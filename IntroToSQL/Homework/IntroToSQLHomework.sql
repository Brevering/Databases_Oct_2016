...
-- PLEASE note i find this utterly ridiculous, but that's what the problem says to do...
...
SELECT e.FirstName, e.LastName, d.Name FROM Employees e INNER JOIN Departments d ON e.DepartmentID = d.DepartmentID
